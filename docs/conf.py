...
author = u'Philipp Sommer, Jed Kaplan'
...
version = re.match('\d+\.\d+\.\d+', gwgen.__version__).group()
# The full version, including alpha/beta/rc tags.
release = gwgen.__version__
...
latex_documents = [
  (master_doc, 'gwgen.tex', u'gwgen Documentation',
...
man_pages = [
    (master_doc, 'gwgen', u'gwgen Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'gwgen', u'gwgen Documentation',
   author, 'gwgen', 'A global weather generator for daily data',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'model_organization': (
        'http://model-organization.readthedocs.io/en/latest/', None),
}
if six.PY3:
